...
var Table = Class.extend({
    ...
    _destroyRecord: function(recordArrayOrId, done) {
        if (isArray(recordArrayOrId)) {
            var that = this;
            var queryParams = {records: recordArrayOrId};
            ...
            var record = new Record(this, recordArrayOrId);
            record.destroy(done);
        }
    },
